...
<form id="form1" name="form1" action="profileupdateServlet?id=<%=objAIbean.getUserid()%>" method="post" enctype="multipart/form-data">
<div class="frm">
<div class="title">Profile</div>
<div class="imge"> <input type="image" name="imageField" id="imageField" onClick="return image();" src="photodisplay.jsp" width="200" height="200">
