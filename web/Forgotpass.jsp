...
<div class="forgot1"><form action="EmailSendingServlet" method="post"><table width="318" height="75" cellpadding="5">
    <tr>
    ...
    <tr>
      ...
      <td style="text-align: center"><input type="submit" name="frgt" id="submit2" value="Reset pass"></td>
    </tr>
  </table>
  <div id="message"></div>
  </form></div>
